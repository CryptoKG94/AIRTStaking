...
const privateKeys = process.env.PRIVATE_KEY; //fs.readFileSync('balls.secret').toString().trim();
...
module.exports = {
    ...
    networks: {
        ...
        testnet: {
            provider: () => new HDWalletProvider(privateKeys, `https://speedy-nodes-nyc.moralis.io/cfe9228e4c2f75a9e06337c7/bsc/testnet`),
